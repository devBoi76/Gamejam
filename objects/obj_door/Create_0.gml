...
was_on = global.save.levers[index];
...
{
	var closing_stage = floor( _height / global.universal_constant )
...
function update(_closing_stage)
{
	...
	for( var _i = 0 ; _i < (sprite_get_height(sprite_index) / global.universal_constant)  ; _i ++)
	{
